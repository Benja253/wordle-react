...
fotocredencializadas

fotocredencializados
...
const conTildes = ['á', 'é', 'í', 'ó', 'ú']
const sinTildes = ['a', 'e', 'i', 'o', 'u']
export const dosLetras = [...new Set(palabras.split("\n").filter(e => e.length == 2).map(e => {
  let word = ''
